...
const { insertCompanyAdminDetail, updateCompanyAdminDetail, deleteCompanyAdmin, fetchCompanyAdminDetail, fetchAdmins, generateCSV } = require("../controller/companyAdminCtrl");
