        ...
        if (verify) {
            try {
                ...
                let reqBody = {
                    ...
                    whatsapp_number, instagram, insta_link, facebook, fb_link, videoURL
                };
                ...
                <section className='brand_form'>
                    <div className='company_admin_form'>
                        ...
                        <div className='company_admin_form_field'>
                            ...
                            <input placeholder='video link...' value={videoURL.url || videoURL} onChange={e => setVideoURL(e.target.value)} />
                        </div>
